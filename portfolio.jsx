...
function ResumeButton({ label = "Want the full story?" }) {
  return (
    <div style={{ textAlign: "center", padding: "20px 0 10px" }}>
      ...
      <a href="Lance Hahn Resume.pdf" download="Lance Hahn Resume.pdf" target="_blank" rel="noopener" className="resume-btn" style={{ background: "none", border: "none", cursor: "pointer", display: "inline-block", padding: 0, textDecoration: "none" }}>
...
function SkillsPage() {
  ...
  "Outside of Voice Acting I currently work as a Marketing Associate, make content on a VTuber account (@mylomemoria), and enjoy playing many games — including the Riftbound TCG.",
  ...
  { label: "Currently obsessed with", value: "Riftbound TCG, Bouldering" }];
  ...
  return (
    <div data-screen-label={`Page · ${PAGE_CHAPTERS[page].title}`} style={{ minHeight: "100vh", background: "linear-gradient(135deg, #E8DECE 0%, #DDD0BC 100%)", display: "flex", flexDirection: "column", alignItems: "center", fontFamily: "'Lora', serif", position: "relative" }}>
      ...
      <header style={{ position: "sticky", top: 0, width: "100%", maxWidth: 900, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 24px", background: "rgba(222,212,196,0.95)", backdropFilter: "blur(10px)", zIndex: 50, borderBottom: "1px solid rgba(160,137,108,0.3)", borderRadius: "0 0 12px 12px" }}>
        ...
        <button onClick={() => navigate(PAGES.COVER)} style={{ fontFamily: "'Playfair Display', serif", fontSize: 15, fontWeight: 600, color: brown, background: "none", border: "none", cursor: "pointer", letterSpacing: 1, width: "499px" }}>✦ My Portfolio</button>
